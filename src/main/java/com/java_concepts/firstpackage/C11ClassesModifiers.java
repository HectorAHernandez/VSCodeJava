...
public abstract class C11ClassesModifiers {
  ...
  public static void main(String[] args) {
    ...
    // Class (which are private) from this program, which we are outside of the class
    // 'LoginRestricted.java', we have to create an object of the LoginRestricted class:
    //LoginRestricted loginObj = new LoginRestricted(); // The LoginRestricted class
    //is public, therefore we have access or see it; but when running the program the error
    // "LoginRestricted cannot be resolved to a type" will be generated; because the methods
    // and variable are defined as private and we are to use then from outside the class that
    // define then.
    ...
    // loginObj.loginToApplication2(); //-- Error "Change Visibility of
    //    'loginToApplication()' to 'public'"
    // String logged_user = loginObj.user_name; //-- Error "Change Visibility of
    //     'user_name' to 'public'"
    ...
    // Example: From this program, To access the variables and Methods defined in the
    // LoginOpened Class, we have to create an object of the LoginOpened class:
    LoginOpened loginObj2 = new LoginOpened();
    loginObj2.loginToApplication();
    // OUTUPUT: public method --> Logged into the application userName: Hector password: 1234
    System.out.println(
      "01 public variable --> Logged User: " + loginObj2.userName
    );
    // OUTPUT: public variable --> Logged User: Hector

    System.out.println(
      "01 public variable --> Password: " + loginObj2.password
    );
    // OUTPUT: public variable --> Password: 1234
    ...
    System.out.println(
      "02 Photographer: " +
      addPhotoObj.taken_by +
      " On: " +
      addPhotoObj.day_of_week
    );
    ...
    System.out.println(
      "\n03 Default var as public due to same package: User: " +
      user +
      " password: " +
      pwd
    );
    ...
    System.out.println(
      "\n04 Protected variable as public due to same package: User: " +
      user4 +
      " password: " +
      pwd4
    );
    ...
    // Variables declared directly inside the class  but outside the methods
    // are known as 'instance' variables.

    // instance variable declared with the 'static' modifier are known as static
    ...
    System.out.println("\n06 before: name_static --> " + name_static);
    name_static = "Changed inside main method in same class Static variable";
    System.out.println("06  after: name_static --> " + name_static);
    ...
    // 'static' Common variables are saved in a memory area that belong to the
    ...
    System.out.println(
      "\nOutside-access: Class Number of Wheels: " + CarClassV05.numberOfWheels
    );
    ...
    // 2- 'final' modifier: Can be used with all, Class, variables and
    //     method.
